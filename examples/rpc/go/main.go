...
//
// For an in-process Go embedding, use github.com/puddle-dev/puddle/packages/agent/sdk
...
func main() {
	...
	if tok := os.Getenv("PUDDLECORE_RPC_TOKEN"); tok != "" {

...
func TestMCPResultToPuddle(t *testing.T) {
	if got := mcpResultToPuddle(nil); len(got.Content) == 0 || got.IsError {
	...
	empty := mcpResultToPuddle(&mcp.CallToolResult{})

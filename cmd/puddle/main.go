// Command puddle is a lightweight terminal coding agent.
package main
...
// local builds. Defaults make `puddle --version` print something sensible
...
func main() {
	...
	if err := agent.Run(os.Args[1:], v); err != nil {
		fmt.Fprintln(os.Stderr, "puddle:", err)
		os.Exit(1)
	}
}

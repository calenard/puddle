...
// agent later. On a fresh puddle launch, Swarm.Reload() walks
...
type agentMeta struct {
	...
	// host puddle session: the dashboard only shows agents whose
...
// continue a swarm session across puddle restarts:
//
//	swarmMgr.Reload()

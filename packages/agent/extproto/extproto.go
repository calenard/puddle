...
// spoken between puddle and its extension subprocesses. Both the host
...
//   - Type names ending in "FromExt" are sent by the extension to puddle.
//   - Type names ending in "FromHost" are sent by puddle to the extension.

...
// makeFakePuddleHome scaffolds $PUDDLE_HOME/extensions/ and returns the path.
func makeFakePuddleHome(t *testing.T) string {
	t.Helper()
	home := t.TempDir()
...
func TestUpdateAllExtensions_NoExtensionsDirectory(t *testing.T) {
	// Brand new $PUDDLE_HOME with no extensions/ directory at all.

...
func TestParseGitHubAgentURL(t *testing.T) {
	tests := []struct {
		...
		{"https://github.com/calenard/agents/puddle-maintenance", "calenard", "agents", "HEAD", "puddle-maintenance"},
		{"https://github.com/calenard/agents/tree/main/puddle-maintenance", "calenard", "agents", "main", "puddle-maintenance"},
...
func TestLoadRemotePuddlefileDownloadsTemporaryGitHubArchive(t *testing.T) {
	...
	u, _ := url.Parse("https://github.com/calenard/agents/puddle-maintenance")

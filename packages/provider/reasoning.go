...
// NormalizeReasoning canonicalizes puddle's user-facing thinking levels.
...
// ReasoningBudget returns puddle's approximate token budget for thinking-capable
...
// AnthropicAdaptiveEffort maps puddle's user-facing thinking levels onto the
...
// OpenAIReasoningEffort maps puddle's thinking setting onto the effort enum
...
// OpenAICompatAnthropicEffort maps puddle's thinking setting when an adaptive
...
// OpenAICodexReasoningEffort maps puddle levels onto the Responses API effort

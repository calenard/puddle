...
//
//   - Older puddle builds that persisted the assistant tool_use row
...
// Cleans up the backlog of empty stubs created by old puddle versions
...
// appended (the user opened puddle, looked around, and exited without
